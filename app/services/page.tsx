...
const TIERS = [
  {
    ...
    priceMax: "$300",
    blurb:
      "A clean, modern presence for businesses that just need to show up online and look good doing it.",
    icon: Layout,
  ...
  },
  {
    ...
    priceMax: "$500",
    blurb:
      "A complete site for businesses that want polish, structure, and search visibility from day one.",
    icon: LayoutDashboard,
    accent: "text-indigo-300 bg-indigo-500/15",
    features: [
      "5 to 8 pages",
      "Stronger layout system",
  ...
  },
  {
    ...
    priceMax: "$500+",
    blurb:
      "For businesses that need more pages, custom flows, or integrations like booking or quoting.",
    icon: Sparkles,
    ...
    cta: "Talk through a Premium build",
    highlight: false,
  },
];
